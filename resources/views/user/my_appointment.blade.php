  ...
  <div align="center" style="padding: 70px;">
    <table>
        ...
        <tr style="background-color: black; color: white;" >
            ...
            <th style="padding: 10px; font-size: 20px;">Messages</th>
        ...
        <tr style="background-color: black; color: white;" align="center">
            ...
            <td style="padding: 10px; font-size: 20px;">{{$appoints->messsage}}</td>
            <td style="padding: 10px; font-size: 20px;">{{$appoints->status}}</td>
            <td style="padding: 10px; font-size: 20px;"><a class="btn btn-danger" onclick="return comfirm('are you sure to delete this')" href="{{url('cancel_appoint', $appoints->id)}}">Cancle</a></td>
        </tr>
